  ...
  return (
    <div className="p-4 md:pr-20 h-screen md:ml-[320px] pt-20">
      <Card className="md:p-10 p-4 dark:bg-gray-800">
        <h1 className="text-2xl font-bold mb-2">Let’s Create a Blog</h1>
        <p className="text-gray-600 dark:text-gray-300">
          Every blog starts with an idea worth sharing. Whether it’s about
          technology, travel, design, personal growth, or creativity — your
          words can inspire, inform, and connect with people. Give your blog a
          title, choose the right category, and start creating content that
          leaves an impact.
        </p>
