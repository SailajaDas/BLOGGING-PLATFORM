...
import heroImg from "../assets/blog4.png";
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:my-0">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-lg md:text-xl opacity-80 mb-6 ">
            Create and share your ideas with the world. Whether you're a writer,
            developer, or storyteller - this is your place to inspire and
